			...
			<div class="inner">
				...
				<section>
					<header class="main">
						...
						<input type="button" value="新增" onclick="location.href='http://localhost:8080/jspTeam5/html/teacStu/insertpagestud.jsp'">
					</header>
						<form method="post" action="<c:url value='/Servlet/searchLikeStud' />">
							<input type="text" name="search" id="search" placeholder="Search" style="width:80%" />
						</form>
						<br>
						<div>
						<form method="post" action="<c:url value='/Servlet/switchsequenceStud' />">
						<h3>請選擇排列方式</h3>
						...
						<div>
						<form method="post" action="<c:url value='/Servlet/searchallStudbyprice' />">
									...
									<tbody>
										<tr>
											<td>${bean.studno}</td>
     										...
     										<td>${bean.learnLoc}</td>
     										<td><img height='100' width='80'src="<c:url value='/_05_teacStu.Servlet/picsaveStud.do?id=${bean.studno}' />"></td>
     										<td><input type="button" value="修改" onclick="location.href='http://localhost:8080/jspTeam5/Servlet/datasaveStud?studno=${bean.studno}'"></td>
     										<td><form method="post" action="<c:url value='/Servlet/deletedataStud'/>"> <button name="studno" value="${bean.studno}">刪除</button></form></td>
										</tr>
									</tbody>
									</c:forEach>
									</table>
