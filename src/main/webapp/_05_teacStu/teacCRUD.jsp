			...
			<div class="inner">
				...
				<section>
					<header class="main">
						...
						<input type="button" value="新增" onclick="location.href='http://localhost:8080/jspTeam5/html/teacStu/insertpage.jsp'">
					</header>
									...
									<tbody>
										<tr>
											<td>${bean.teacno}</td>
     										...
     										<td><img height='100' width='80'src="<c:url value='/_05_teacStu.Servlet/picsave.do?id=${bean.teacno}' />"></td>
