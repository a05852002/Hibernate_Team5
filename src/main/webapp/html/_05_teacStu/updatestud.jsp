				...
				<section>
					<header class="main">
						<h1>請修改您的資料</h1>
							...
							<form action='<c:url value="/_05_teacStu/updatedataStud" />' enctype='multipart/form-data' method='post'>
								<table class="alt">
								<c:forEach var="bean" items="${bean}">
									<thead>
										...
										<br>
										<img id="preImg" style="width:150px; height:200px" src="<c:url value='/_05_teacStu/picsaveStud?id=${bean.studno}' />" />
										</td></tr>
									</thead>
								</c:forEach>
									</table>
